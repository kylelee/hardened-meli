...
easy to take MORE than nothing.'"#;
        let got = split_lines_reflow(text, Reflow::FormatFlowed, Some(30))
            .into_iter()
            .collect::<Vec<_>>();
        assert_eq!(
            got.as_slice(),
        ...
        let got = split_lines_reflow(text, Reflow::No, Some(30))
            .into_iter()
            .collect::<Vec<_>>();
        assert_eq!(
            got.as_slice(),
...
>MORE than nothing."#;
        let got = split_lines_reflow(text, Reflow::FormatFlowed, Some(20))
            .into_iter()
            .collect::<Vec<_>>();
        assert_eq!(
            got.as_slice(),
        ...
        let got = split_lines_reflow(text, Reflow::No, Some(20))
            .into_iter()
            .collect::<Vec<_>>();
        assert_eq!(
            got.as_slice(),
        ...
        let got = split_lines_reflow(
            crate::text::_ALICE_CHAPTER_1,
            Reflow::FormatFlowed,
            Some(72),
        )
        .into_iter()
        ...
        assert_eq!(
            ...
            &[
                ...
                "after it, and fortunately was just in time to see ",
